...
@Component({ name: 'IconTelegram.vue' })
export default class IconTelegram extends SvgIconBase {
  @Prop({ default: 'telegram' }) readonly title!: string;
